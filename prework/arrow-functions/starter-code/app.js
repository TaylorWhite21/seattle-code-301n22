...
//    "this" refers to the name, age, and hometown in the constructor
// 2. What is "this" when joe.scopeArrow() is invoked?
//    "this" is meant to refer to the Student object but it is unable to because an arrow function cannot perform that.
// 3. Explain why "this" is different when an arrow function is used.
//  When 'this" is used inside an arrow function it only refers to the enxlosing scope.
